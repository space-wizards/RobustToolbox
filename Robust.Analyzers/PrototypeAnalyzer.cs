...
public sealed class PrototypeAnalyzer : DiagnosticAnalyzer
{
    ...
    private void AnalyzePrototype(SyntaxNodeAnalysisContext context)
    {
        ...
        if (prototypeAttribute.ArgumentList == null || prototypeAttribute.ArgumentList.Arguments[0] is not AttributeArgumentSyntax argumentSyntax)
        {
        ...
        if (!literalValue.HasValue || literalValue.Value is not string specifiedName)
            return;
