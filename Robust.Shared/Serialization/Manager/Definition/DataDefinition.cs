...
namespace Robust.Shared.Serialization.Manager.Definition
{
    public sealed partial class DataDefinition
    {
        ...
        internal DataDefinition(Type type, IDependencyCollection collection, InstantiationDelegate<object> instantiator)
        {
            Type = type;
        ...
        private List<FieldDefinition> GetFieldDefinitions(InstantiationDelegate<object> instantiator, bool isRecord)
        {
            ...
            {
                if (abstractFieldInfo.IsBackingField() || abstractFieldInfo.IsAutogeneratedRecordMember())
                    continue;
