...
namespace Robust.UnitTesting.Shared.Serialization.TypeSerializers
{
    ...
    internal sealed class ComponentRegistrySerializerTest : OurSerializationTest
    {
        ...
        public void SerializationTest()
        {
            ...
            var registry = new ComponentRegistry {{"Test", new ComponentRegistryEntry(component)}};
