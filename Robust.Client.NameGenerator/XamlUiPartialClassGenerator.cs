...
";
        ...
        private static DiagnosticSeverity GetSeverity(XamlDiagnosticSeverity severity)
        {
        ...
        private static bool HandleDiagnostics(IEnumerable<XamlDiagnostic> diagnostics,
            ...
            GeneratorExecutionContext context)
        {
            ...
            if (initialRoot.Type.GetClrType().Id is not INamedTypeSymbol)
            {
                ...
                throw new Exception($"uhhh? {kind} {kind.Id} {kind.Name}");
            }
