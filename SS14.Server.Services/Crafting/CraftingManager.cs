...
namespace SS14.Server.Services.Crafting
{
    [Serializable]
    ...
    public sealed class CraftingManager : ICraftingManager
    {
        ...
        public void HandleCraftRequest(NetIncomingMessage msg)
        {
            ...
            {
                NetOutgoingMessage failCraftMsg = IoCManager.Resolve<ISS14NetServer>().CreateMessage();
        ...
        {
            NetOutgoingMessage cancelCraftMsg = IoCManager.Resolve<ISS14NetServer>().CreateMessage();
        ...
        {
            NetOutgoingMessage inventoyFullMsg = IoCManager.Resolve<ISS14NetServer>().CreateMessage();
        ...
        {
            NetOutgoingMessage busyMsg = IoCManager.Resolve<ISS14NetServer>().CreateMessage();
        ...
        {
            NetOutgoingMessage missingMsg = IoCManager.Resolve<ISS14NetServer>().CreateMessage();
