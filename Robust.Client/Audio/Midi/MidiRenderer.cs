...
internal sealed partial class MidiRenderer : IMidiRenderer
{
    ...
    public bool OpenMidi(ReadOnlySpan<byte> buffer)
    {
        ...
        lock (_playerStateLock)
        {
            ...
            if (_tempoScale != 1.0)
                FluidsynthNative.fluid_player_set_tempo(_player.Handle, FluidPlayerTempoInternal, _tempoScale);
        }
    ...
    public void SetChannelFilterCutoff(int channel, float cutoffCents)
    {
        ...
        lock (_playerStateLock)
        {
            FluidsynthNative.fluid_synth_set_gen(_synth.Handle, channel, GenFilterCutoff, cutoffCents);
        }
    }
    ...
    public void SetTempoScale(double scale)
    {
        ...
        {
            if (_player != null)
                FluidsynthNative.fluid_player_set_tempo(_player.Handle, FluidPlayerTempoInternal, scale);
        }
    }
    ...
    public void SetChannelPitch(int channel, int semitones)
    {
        ...
        lock (_playerStateLock)
        {
            FluidsynthNative.fluid_synth_set_gen(_synth.Handle, channel, GenCoarseTune, (float)semitones);
        }
    }
