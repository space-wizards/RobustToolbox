...
public static class Diagnostics
{
    ...
    public const string IdHasDependenciesNotPartial = "RA0048";
    public const string IdHasDependenciesNotPartialParent = "RA0049";
    public const string IdHasDependenciesReadOnly = "RA0050";
    public const string IdHasDependenciesPropertyField = "RA0051";
