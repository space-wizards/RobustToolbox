...
internal partial class Clyde
{
    private sealed partial class SdlWindowingImpl
    {
        ...
        {
            EmitKeyEvent(ConvertSdl2Scancode(ev.Scancode), ev.Type, ev.Repeat, (SDL_Keymod)ev.Mods, ev.Scancode);
        }
        ...
        private void EmitKeyEvent(Key key, SDL_EventType type, bool repeat, SDL_Keymod mods, SDL_Scancode scancode)
        {
            ...
            var control = (mods & SDL_Keymod.Ctrl) != 0;
            var system = (mods & SDL_Keymod.Gui) != 0;
        ...
        {
            var type = ev.Message switch
            {
                WM.WM_KEYUP => SDL_EventType.KeyUp,
                WM.WM_KEYDOWN => SDL_EventType.KeyDown,
