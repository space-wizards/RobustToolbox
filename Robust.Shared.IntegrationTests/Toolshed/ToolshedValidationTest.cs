...
internal sealed class ToolshedValidationTest : ToolshedTest
{
#if DEBUG
    [Test]
...
internal sealed class TestInvalid1Command : ToolshedCommand
{
...
[ToolshedCommand, Reflect(false)]
internal sealed class TestInvalid2Command : ToolshedCommand
{
...
[ToolshedCommand, Reflect(false)]
internal sealed class TestInvalid3Command : ToolshedCommand
{
    public override Type[] TypeParameterParsers => [typeof(TypeTypeParser)];
...
[ToolshedCommand, Reflect(false)]
internal sealed class TestInvalid4Command : ToolshedCommand
{
    public override Type[] TypeParameterParsers => [typeof(TypeTypeParser)];
    [CommandImplementation, TakesPipedTypeAsGeneric]
...
[ToolshedCommand, Reflect(false)]
internal sealed class TestInvalid5Command : ToolshedCommand
{
    [CommandImplementation, TakesPipedTypeAsGeneric]
    public void Impl<T>() {}
}
...
[ToolshedCommand, Reflect(false)]
internal sealed class TestInvalid6Command : ToolshedCommand
{
    [CommandImplementation]
...
[ToolshedCommand, Reflect(false)]
internal sealed class TestInvalid7Command : ToolshedCommand
{
    [CommandImplementation]
...
// Conflicting arguments
[ToolshedCommand, Reflect(false)]
internal sealed class TestInvalid8Command : ToolshedCommand
{
    [CommandImplementation]
...
[ToolshedCommand, Reflect(false)]
internal sealed class TestInvalid9Command : ToolshedCommand
{
    [CommandImplementation]
...
[ToolshedCommand, Reflect(false)]
internal sealed class TestInvalid10Command : ToolshedCommand
{
    [CommandImplementation]
...
[ToolshedCommand, Reflect(false)]
internal sealed class TestInvalid11Command : ToolshedCommand
{
    [CommandImplementation]
...
[ToolshedCommand, Reflect(false)]
internal sealed class TestInvalid12Command : ToolshedCommand
{
    [CommandImplementation]
...
[ToolshedCommand, Reflect(false)]
internal sealed class TestInvalid13Command : ToolshedCommand
{
    public override Type[] TypeParameterParsers => [typeof(TypeTypeParser)];
    [CommandImplementation, TakesPipedTypeAsGeneric]
...
[ToolshedCommand, Reflect(false)]
internal sealed class TestInvalid14Command : ToolshedCommand
{
    public override Type[] TypeParameterParsers => [typeof(TypeTypeParser), typeof(TypeTypeParser)];
    [CommandImplementation, TakesPipedTypeAsGeneric]
...
[ToolshedCommand, Reflect(false)]
internal sealed class TestInvalid15Command : ToolshedCommand
{
    [CommandImplementation, TakesPipedTypeAsGeneric]
...
[ToolshedCommand, Reflect(false)]
internal sealed class TestInvalid16Command : ToolshedCommand
{
    public override Type[] TypeParameterParsers => [typeof(TypeTypeParser)];
...
[ToolshedCommand, Reflect(false)]
internal sealed class TestInvalid18Command : ToolshedCommand
{
    [CommandImplementation]
