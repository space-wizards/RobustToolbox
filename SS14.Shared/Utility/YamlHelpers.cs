...
namespace SS14.Shared.Utility
{
    public static class YamlHelpers
    {
        ...
        public static Vector2i AsVector2i(this YamlNode node)
        {
            ...
            return new Vector2i(int.Parse(args[0]), int.Parse(args[1]));
        }
        ...
        {
            return mapping.ToDictionary<KeyValuePair<YamlNode, YamlNode>, string, YamlNode>(p => p.Key.AsString(), p => p.Value);
        }
    }
}
