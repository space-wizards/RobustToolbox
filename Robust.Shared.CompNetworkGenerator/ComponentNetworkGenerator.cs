...
{handleStateSetters}{eventRaise}";
            ...
            partialTypeInfo.WriteHeader(header);
            partialTypeInfo.WriteFooter(footer);
...
";
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            foreach (var type in symbols)
            {
                try
                {
                    ...
                    var source = GenerateSource(context, type.Type, type.Syntax, comp, raiseEv, fieldDeltas);
        ...
        private IReadOnlyList<(INamedTypeSymbol Type, ClassDeclarationSyntax Syntax, AttributeData Attribute)> GetAnnotatedTypes(in GeneratorExecutionContext context,
            CSharpCompilation comp, NameReferenceSyntaxReceiver receiver)
        {
            var symbols = new List<(INamedTypeSymbol, ClassDeclarationSyntax, AttributeData)>();
