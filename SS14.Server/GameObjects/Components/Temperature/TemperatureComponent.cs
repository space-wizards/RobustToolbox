...
namespace SS14.Server.GameObjects
{
    ...
    class TemperatureComponent : Component
    {
        ...
        /// <inheritdoc />
        public override uint? NetID => NetIDs.TEMPERATURE;

        //TODO: should be programmatic instead of how it currently is
        public float CurrentTemperature { get; private set; } = TemperatureConstants.ZERO_CELCIUS;
        ...
        public override void Update(float frameTime)
        {
            ...
            {
                component?.TakeDamage(DamageType.Fire, fireDamage);
