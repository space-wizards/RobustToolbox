...
namespace Robust.Shared.Localization
{
    internal abstract partial class LocalizationManager
    {
        ...
        /// </summary>
        public void AddPrototypeFunctions()
        {
            if (DefaultCulture is not { } culture)
            {
                _logSawmill.Debug("No culture found. Failed to generate prototype-based locale functions.");
                return;
            }
        ...
        {
            var outGender = "";
            if (tense.FtlReturn is not { } function) // this should not happen
