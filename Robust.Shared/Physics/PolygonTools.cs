...
namespace Robust.Shared.Physics
{
    public static class PolygonTools
    {
        ...
        public static Vertices CreateRectangle(float hx, float hy, Vector2 center, float angle)
        {
            ...
            PhysicsTransform xf = new PhysicsTransform(center, angle);

            // Transform vertices
            for (int i = 0; i < 4; ++i)
            {
                vertices[i] = PhysicsMath.Multiply(vertices[i], xf);
            }
                                                      ...
                                                      int segments)
        {
            ...
            Debug.Assert(PhysicsSettings.MaxPolygonVertices >= 8);
        ...
        /// <summary>
        /// Creates a capsule with the specified  height, radius and number of edges.
        /// A capsule has the same form as a pill capsule.
        /// </summary>
        ...
        public static Vertices CreateGear(float radius, int numberOfTeeth, float tipPercentage, float toothHeight)
        {
            ...
            tipPercentage /= 100f;
            Math.Clamp(tipPercentage, 0f, 1f);
