        ...
        initContext.RegisterSourceOutput(
            ...
            static (sourceContext, source) =>
            {
                ...
                foreach (var declaration in declarations)
                {
                    ...
                    var nonPartial = !Helpers.IsPartial(declaration);
                    ...
                    nonPartial |= !allContainingPartial;
...
[RobustAutoGenerated]
{{Helpers.GetPartialTypeDefinitionLine(type)}} : ISerializationGenerated<{{definition.GenericTypeName}}>
{
