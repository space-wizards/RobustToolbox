...
namespace Robust.Shared.Utility
{
    ...
    public sealed partial class _FormattedMessage
    {
        ...
        public _FormattedMessage()
        {
            _tags = new List<Tag>();
        }

        public _FormattedMessage(int capacity)
        {
            _tags = new List<Tag>(capacity);
        }

        public static _FormattedMessage FromMarkup(string markup)
        {
            var msg = new _FormattedMessage();
            msg.AddMarkup(markup);
            return msg;
        }

        public static _FormattedMessage FromMarkupPermissive(string markup)
        {
            var msg = new _FormattedMessage();
        ...
        public _FormattedMessage(_FormattedMessage toCopy)
        {
        ...
        public void AddMessage(_FormattedMessage other)
        {
        ...
        public _FormattedMessageRuneEnumerator EnumerateRunes()
        {
            return new _FormattedMessageRuneEnumerator(this);
        }
    ...
    public struct _FormattedMessageRuneEnumerator : IEnumerable<Rune>, IEnumerator<Rune>
    {
        private readonly _FormattedMessage _msg;
        private List<_FormattedMessage.Tag>.Enumerator _tagEnumerator;
        private StringRuneEnumerator _runeEnumerator;

        internal _FormattedMessageRuneEnumerator(_FormattedMessage msg)
        {
            _msg = msg;
        ...
        public bool MoveNext()
        {
            ...
            {
                _FormattedMessage.TagText text;
                while (true)
                {
                    ...
                    if (_tagEnumerator.Current is not _FormattedMessage.TagText { Text.Length: > 0 } nextText)
                        continue;
