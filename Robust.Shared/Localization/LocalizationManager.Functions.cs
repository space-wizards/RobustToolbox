...
namespace Robust.Shared.Localization
{
    internal abstract partial class LocalizationManager
    {
        ...
        /// <summary>
        ///     Built in functions reliant on prototypes. Ctx functions are autogenerated here for yml defined inflections.
        ...
        public void AddPrototypeFunctions()
        {
            ...
            foreach (var inflection in _prototype.EnumeratePrototypes<PronounGrammarPrototype>())
                if (inflection.FtlFunction is { } function &&
                    inflection.FtlReturn is { })
                    AddCtxFunction(bundle, function, args => FuncAutoGenerate(args, inflection));
        }

        /// <summary>
        ///     Handles functions autogenerated by pronounGrammar prototype.
        ///     Will return the the relevant pronoun's string conjugation reliant on inflection,
