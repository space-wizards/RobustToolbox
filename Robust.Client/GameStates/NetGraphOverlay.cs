...
namespace Robust.Client.GameStates
{
    ...
    internal sealed class NetGraphOverlay : Overlay
    {
        ...
        private void HandleGameStateApplied(GameStateAppliedArgs args)
        {
            ...
            // calc interp info
            var buffer = _gameStateManager.ApplicableStateCount;
        ...
        protected internal override void Draw(in OverlayDrawArgs args)
        {
            ...
            // buffer text
            handle.DrawString(_font, new Vector2(LeftMargin, height + LowerGraphOffset), $"{_gameStateManager.ApplicableStateCount.ToString()} states");
        }
