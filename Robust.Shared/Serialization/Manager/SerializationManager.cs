    ...
    public sealed partial class SerializationManager : ISerializationManager
    {
        ...
        public void Initialize()
        {
            ...
            Parallel.ForEach(registrations, type =>
            {
                ...
                DataDefinitions.GetValue(type, t => CreateDataDefinition(t, DependencyCollection, this));
            });
        ...
        private static DataDefinition CreateDataDefinition(Type t, IDependencyCollection collection, ISerializationManager serv3Mgr)
        {
            return new(t, collection, serv3Mgr);
        }
