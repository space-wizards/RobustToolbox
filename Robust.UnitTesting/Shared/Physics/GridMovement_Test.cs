...
public sealed class GridMovement_Test : RobustIntegrationTest
{
    ...
    public async Task TestFindGridContacts()
    {
        ...
        await server.WaitAssertion(() =>
        {
            ...
            physSystem.CreateFixture(onGrid, "fix1", new Fixture(shapeA, 1, 0, false), body: onGridBody);
            Assert.That(onGridBody.Fixtures.Count, Is.EqualTo(1));
            ...
            physSystem.CreateFixture(offGrid, "fix1", new Fixture(shapeB, 0, 1, false), body: offGridBody);
            Assert.That(offGridBody.Fixtures.Count, Is.EqualTo(1));
