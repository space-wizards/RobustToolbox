...
namespace Robust.Client.ViewVariables
{
    internal class ViewVariablesManager : ViewVariablesManagerShared, IViewVariablesManagerInternal
    {
        ...
        public ViewVariablesPropertyEditor PropertyFor(Type type)
        {
            ...
            {
                return new ViewVariablesPropertyEditorNumeric(ViewVariablesPropertyEditorNumeric.NumberType.SByte);
            }

            if (type == typeof(byte))
            {
                return new ViewVariablesPropertyEditorNumeric(ViewVariablesPropertyEditorNumeric.NumberType.Byte);
            }

            if (type == typeof(ushort))
            {
                return new ViewVariablesPropertyEditorNumeric(ViewVariablesPropertyEditorNumeric.NumberType.UShort);
            }

            if (type == typeof(short))
            {
                return new ViewVariablesPropertyEditorNumeric(ViewVariablesPropertyEditorNumeric.NumberType.Short);
            }

            if (type == typeof(uint))
            {
                return new ViewVariablesPropertyEditorNumeric(ViewVariablesPropertyEditorNumeric.NumberType.UInt);
            }

            if (type == typeof(int))
            {
                return new ViewVariablesPropertyEditorNumeric(ViewVariablesPropertyEditorNumeric.NumberType.Int);
            }

            if (type == typeof(ulong))
            {
                return new ViewVariablesPropertyEditorNumeric(ViewVariablesPropertyEditorNumeric.NumberType.ULong);
            }

            if (type == typeof(long))
            {
                return new ViewVariablesPropertyEditorNumeric(ViewVariablesPropertyEditorNumeric.NumberType.Long);
            }

            if (type == typeof(float))
            {
                return new ViewVariablesPropertyEditorNumeric(ViewVariablesPropertyEditorNumeric.NumberType.Float);
            }

            if (type == typeof(double))
            {
                return new ViewVariablesPropertyEditorNumeric(ViewVariablesPropertyEditorNumeric.NumberType.Double);
            }

            if (type == typeof(decimal))
            {
                return new ViewVariablesPropertyEditorNumeric(ViewVariablesPropertyEditorNumeric.NumberType.Decimal);
            }
