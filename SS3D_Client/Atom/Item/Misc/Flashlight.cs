...
namespace SS3D.Atom.Item.Misc
{
    public class Flashlight : Item
    {
        ...
        public override void HandlePush(Lidgren.Network.NetIncomingMessage message)
        {
            ...
            if (light == null)
            {
                light = new Light(atomManager.gameState.map, Color.FromArgb(r, g, b), 250, LightState.On, atomManager.gameState.map.GetTileArrayPositionFromWorldPosition(position), d);
            }
            else
            {
