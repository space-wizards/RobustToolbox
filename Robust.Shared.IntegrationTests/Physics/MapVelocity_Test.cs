...
";
        ...
        public async Task TestMapVelocities()
        {
            ...
            await server.WaitAssertion(() =>
            {
                ...
                var dummy = entityManager.SpawnAttachedTo(DummyEntity, new EntityCoordinates(grid, offset));
        ...
        public async Task TestNestedParentVelocities()
        {
            ...
            await server.WaitAssertion(() =>
            {
                ...
                var dummy1 = entityManager.SpawnAttachedTo(DummyEntity, new EntityCoordinates(gridUid, offset1));
                ...
                var dummy2 = entityManager.SpawnAttachedTo(DummyEntity, new EntityCoordinates(dummy1, offset2));
