...
namespace Robust.UnitTesting.Shared.Map
{
    ...
    sealed class MapGrid_Tests
    {
        ...
        public void GetTileRefCoords()
        {
            ...
            grid.SetTile(new Vector2i(-9, -1), new Tile(1, (TileFlag)1, 1));
            ...
            Assert.That(result, Is.EqualTo(new TileRef(mapId, grid.Index, new Vector2i(-9,-1), new Tile(1, (TileFlag)1, 1))));
        }
        ...
        public void TryGetTileRefTileExists()
        {
            ...
            Assert.That(grid.ChunkCount, Is.EqualTo(1));
            Assert.That(grid.GetMapChunks().Keys.ToList()[0], Is.EqualTo(new Vector2i(-2, -1)));
            Assert.That(tileRef, Is.EqualTo(new TileRef(mapId, grid.Index, new Vector2i(-9, -1), new Tile(1, (TileFlag)1, 1))));
        }
