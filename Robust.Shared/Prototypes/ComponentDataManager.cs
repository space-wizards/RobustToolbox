...
namespace Robust.Shared.Prototypes
{
    public class ComponentDataManager : IComponentDataManager
    {
        ...
        private Type GetComponentDataType(string compName)
        {
            ...
            var generatedType = _reflectionManager.GetType($"{compType.Name}_AUTODATA");
        ...
        public void PopulateComponent(IComponent comp, IComponentData values)
        {
        ...
        public void PushInheritance(string compName, IComponentData source, IComponentData target)
        {
        ...
        public IComponentData GetEmptyComponentData(string compName)
        {
            var compData = (IComponentData?)Activator.CreateInstance(GetComponentDataType(compName));
            if (compData == null)
        ...
        public IComponentData ParseComponentData(string compName, YamlMappingNode mapping, YamlObjectSerializer.Context? context = null)
        {
