    ...
    where TLayeredComp : Component, ILayeredComponentTreeEntry<TLayeredComp>, new()
{
    ...
    protected override void OnTreeAdd(EntityUid uid, TLayeredTreeComp component, ComponentAdd args) // Really Needs refactor
    {
    ...
    #region Queries
    public IEnumerable<(EntityUid, TLayeredTreeComp, DynamicTree<ComponentTreeEntry<TLayeredComp>>, int layerIndex)> GetIntersectingTreeLayers(MapId mapId, Box2Rotated worldBounds, int[]? layers = null) // Really Needs refactor
