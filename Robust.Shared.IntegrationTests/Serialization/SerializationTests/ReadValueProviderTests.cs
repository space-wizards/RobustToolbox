...
internal sealed partial class ReadValueProviderTests : OurSerializationTest
{
    ...
    [DataDefinition]
    internal sealed partial class DataDefinitionValueProviderTestDummy : IBaseInterface
    {
        [DataField("data")] public string Data = string.Empty;
    }

    internal sealed class OtherDataDefinitionValueProviderTestDummy : IBaseInterface{}
